            ...
            <div id="footer" className="css-1i60c0e ebj6vxr5">
                <div className="css-j6zuv6 ebj6vxr4">
                    <div className="css-0 eam2qm511"><h2 className="css-4iyald eam2qm510">고객행복센터</h2><strong
                        ...
                        <div className="css-vtjvf eam2qm51">비회원 문의 : <a
                            href="mailto:help@kurlycorp.com">liotex@naver.com</a></div>
                    </div>
                    <div className="css-1fttcpj ebj6vxr3">
                        <ul className="css-17hse91 e13nap1l2">
                            <li className=" css-slkv2p e13nap1l1"><a href="/introduce" target="_self"
                                                                     className="css-1tfhwyj e13nap1l0">킴스몰 소개</a></li>
                        ...
                        <div className="css-bz7mfs ebj6vxr2">법인명 (상호) : 킴스몰 <span
                            className="css-1ekjygq ebj6vxr1"></span> 사업자등록번호 : 000-00-00000 <a
                            ...
                            : 제 2018-서울강남-01646 호<br/>주소 : 서울특별시 관악구 신림동 485-44, 103호 <span
                                className="css-1ekjygq ebj6vxr1"></span> 대표이사 : 김태욱<br/>채용문의 :<a
                                href="mailto:recruit@kurlycorp.com"
                                className="css-1tby8gd ebj6vxr0">liotex@naver.com</a><br/>팩스: 070 - 000 - 0000
                        </div>
                        <ul className="css-zjik7 ek68y4g1"><a href="https://instagram.com/marketkurly"
                                                              target="_blank" rel="noreferrer"
                                                              className="css-9ipg3 ek68y4g0"><img
                            src="https://res.kurly.com/pc/ico/1810/ico_instagram.png" alt="인스타그램 바로가기"/></a><a
                            ...
                            className="css-9ipg3 ek68y4g0"><img
                            src="https://res.kurly.com/pc/ico/1810/ico_naverpost.png" alt="네이버포스트 바로가기"/></a><a
                            href="https://www.youtube.com/channel/UCfpdjL5pl-1qKT7Xp4UQzQg" target="_blank"
                            rel="noreferrer" className="css-9ipg3 ek68y4g0"><img
                            src="https://res.kurly.com/pc/ico/1810/ico_youtube.png" alt="유튜브 바로가기"/></a></ul>
                    </div>
                </div>
                <div className="css-81eeg3 e1t23cq0">
                    <button className="css-12t5wjq e57xuci2"><img
                        ...
                        className="css-1262i6n e57xuci1"/><p className="css-bft4sh e57xuci0">[인증범위] 쇼핑몰 서비스 개발·운영<br/>(심사받지
