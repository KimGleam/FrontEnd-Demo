            ...
            <div id="detail" class="css-18eozqj el27cq0">
                ...
                <div class="css-1vc740i e11kghol1">
                    ...
                    <ul class="css-1lb3ltj ej1h6cm3">
                        ...
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">축산물 - ｢축산법｣에 따른 등급 표시(1++ 등급 국내산 쇠고기의 경우 ｢소ㆍ돼지 식육의 표시방법 및 부위
                            구분기준｣에 따라 근내지방도 정보를 포함하여 표시), ｢가축 및 축산물 이력관리에 관한 법률｣에 따른 이력관리대상축산물 유무
                        </li>
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">수입 농수축산물 – “수입식품안전관리 특별법에 따른 수입신고를 필함”의 문구</li>
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">상품구성</li>
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">보관방법 또는 취급방법</li>
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">소비자 안전을 위한 주의사항 (｢식품 등의 표시ㆍ광고에 관한 법률 시행규칙｣ 제5조 및 [별표 2]에 따른
                            표시사항을 말함)
                        </li>
                        <li class="css-15ohb0b ej1h6cm0">상품설명 및 상품이미지 참조</li>
                        <li class="css-1exh1as ej1h6cm1">소비자 상담 관련 전화번호</li>
                ...
                <div class="css-1vt9a6q e1711h2r7">
                    ...
                    <div class="css-4xwwak e1711h2r4">
                        <dl class="css-12dlzwv e1711h2r3">
                            ...
                            <dd class="css-164ekbt e1711h2r1">나와 내 가족이 먹고 쓸 상품을 고르는<br/>마음으로 매주 상품을 직접 먹어보고,<br/>경험해보고
                                성분, 맛, 안정성 등 다각도의<br/>기준을 통과한 상품만을 판매합니다.
                                <span class="css-1ldxevt e1711h2r0">(온라인 기준 / 자사몰, 직구 제외)</span>
                            </dd>
                        </dl>
                        <dl class="css-12dlzwv e1711h2r3">
                            <dt class="css-csns7h e1711h2r2">차별화된 Kurly Only 상품</dt>
                            <dd class="css-164ekbt e1711h2r1">전국 각지와 해외의 훌륭한 생산자가<br/>믿고 선택하는 파트너, 컬리.<br/>3천여 개가 넘는 컬리
                                단독 브랜드, 스펙의<br/>Kurly Only 상품을 믿고 만나보세요.
                                <span class="css-1ldxevt e1711h2r0">(온라인 기준 / 자사몰, 직구 제외)</span>
                            </dd>
                        </dl>
                        <dl class="css-12dlzwv e1711h2r3">
                            <dt class="css-r24z76 e1711h2r2">신선한 풀콜드체인 배송</dt>
                            <dd class="css-164ekbt e1711h2r1">온라인 업계 최초로 산지에서 문 앞까지<br/>상온, 냉장, 냉동 상품을 분리 포장 후<br/>최적의
                                온도를 유지하는 냉장 배송 시스템,<br/>풀콜드체인으로 상품을 신선하게 전해드립니다.
                                <span class="css-1ldxevt e1711h2r0">(샛별배송에 한함)</span>
                            </dd>
                        </dl>
                        <dl class="css-12dlzwv e1711h2r3">
                            <dt class="css-1s9l9oc e1711h2r2">고객, 생산자를 위한 최선의 가격</dt>
                            <dd class="css-164ekbt e1711h2r1">매주 대형 마트와 주요 온라인 마트의 가격<br/>변동 상황을 확인해 신선식품은 품질을<br/>타협하지
                                않는 선에서 최선의 가격으로,<br/>가공식품은 언제나 합리적인 가격으로<br/>정기 조정합니다.
                            </dd>
                        </dl>
                        <dl class="css-12dlzwv e1711h2r3">
                            <dt class="css-iktv7d e1711h2r2">환경을 생각하는 지속 가능한 유통</dt>
                            <dd class="css-164ekbt e1711h2r1">친환경 포장재부터 생산자가 상품에만<br/>집중할 수 있는 직매입 유통구조까지,<br/>지속 가능한
                                유통을 고민하며 컬리를 있게<br/>하는 모든 환경(생산자, 커뮤니티, 직원)이<br/>더 나아질 수 있도록 노력합니다.
                            </dd>
                        </dl>
                    </div>
                </div>
                    ...
                    <div class="css-o0wurt e18xf2bx9">
                        ...
                        <ul class="css-15889fd e18xf2bx4">
                            ...
                            <li class="css-18zkc1e e18xf2bx3">
                                ...
                                <strong class="css-xjrpkm e18xf2bx0">카카오톡에서 '컬리' 를 검색 후<br/>대화창에 문의 및
                ...
                <div class="css-zym26p e1wuccxq2">
                    ...
                    <p class="css-1sezoog e1wuccxq0">
                        ...
                        <strong class="css-e6zvdp e1u4390v1">유통기한 30일 이상 식품 (신선 / 냉장 / 냉동 제외) &amp; 기타 상품 (뷰티 제품,
                            생활용품)</strong>
