        ...
        <>
            ...
            <div style={{width: '1103px', paddingTop: '100px'}}>
                ...
                <div style={{display: 'flex', alignItems: 'center'}}>
                    ...
                    <div style={{display: 'grid', marginLeft: '8px', width: '875px',
                        height: '1200px', margin:'auto', gridTemplateColumns: 'repeat(auto-fill, 280px)', gap: '17px', cursor: 'pointer'}}>
                        {products.map(card => (
                            <div style={{display: 'flex', flexDirection: 'column', minHeight: '558px', width: '100%'}}>
                                <div style={{height: '320px', borderRadius: '5px'}}>
                                    <span style={{display: 'block', width: '100%', height: '100%'}}>
                                        <img style={{width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px'}}
                                             src={card.image}/>
                                    </span>
                                </div>
